...
from tools import dem_from_mml, write_AsciiGrid, read_AsciiGrid_new
...
outpath = 'F:\Pallaslake_Catchment\GIS_inputs'
outlet_x, outlet_y = 386616.9834, 7548373.16
routing = 'd8'
...
fname=os.path.join(outpath, 'cmask.asc')
